#ifndef _CALIBRATE_TASK_H
#define _CALIBRATE_TASK_H
...
#define cali_flash_read(address, buf, len) STMFLASH_Read((address), (buf), (len))                  //flash 读取函数
#define cali_flash_write(address, buf, len) STMFLASH_Write((address), (buf), (len)) //flash 写入函数
...
void Read_parma_from_flash(void);
